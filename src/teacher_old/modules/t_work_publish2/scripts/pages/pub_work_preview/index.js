...
@View('pub_work_preview', {
    url: '/pub_work_preview',
...
class pubWorkPreviewCtrl {
    ...
    @select(state => state.compose_temp_paper.tempPaperSetParams) setParams;
    @select(state => state.compose_temp_paper.quesList) tempqslist;
    @select(state => state.compose_temp_paper.paperName) paperName;
    constructor(){
            ...
            buttons: [
                {
                    ...
                    onTap: e => {
                        me.pubWorkService.changePaperName(this.paperName);
                        return true;
                    }
                },
                {
    ...
    workPub() {
        ...
        this.pubWorkService.composePaper(params).then((data, msg) => {
            this.gotoPubButnFlag = true;
            if (data) {
                this.goToPub();
            } else {
    ...
    goToPub() {
        ...
        this.go("work_pub2", {from: 'pub_work_preview'});
    }
    ...
    deleteQues() {
        ...
        this.pubWorkService.deleteSelectQues(this.setParams, this.tempqslist);
        this.setChapterName();
    ...
    changeDifficulty(type) {
        ...
        this.pubWorkService.getComposePaperQues(this.setParams, paramType)
            .then((data, msg) => {
                if (data) {
                    this.setChapterName();
...
export default pubWorkPreviewCtrl;