(function (name, definition) {
    ...
    Swiper.prototype._bind = function () {
        ...
        this.$container.addEventListener(PAINT_START, function (e) {
            // if (me._lock) {
            //     return;
            // }
            me._lock = false;
            me._start.x = !isTouch ? e.pageX : e.changedTouches[0].pageX;
            me._start.y = !isTouch ? e.pageY : e.changedTouches[0].pageY;
        ...
        this.$container.addEventListener(PAINT_MOVE, function (e) {
            if (me._lock) {
                return;
            }
            me._move.x = !isTouch ? e.pageX : e.changedTouches[0].pageX;
            me._move.y = !isTouch ? e.pageY : e.changedTouches[0].pageY;
        ...
        this.$container.addEventListener(PAINT_END, function (e) {
            if (me._lock) {
                return;
            }

            me._end.x = !isTouch? e.pageX : e.changedTouches[0].pageX;
            me._end.y = !isTouch? e.pageY : e.changedTouches[0].pageY;
