    ...
    services.factory('dateUtil', ['$log',
        function ($log) {
            ...
            DateFormat.prototype = {
                //定义一些常用的日期格式的常量
                DEFAULT_DATE_CN_FORMAT: 'yyyy年MM月dd日',
                DEFAULT_DATE_TIME_CN_FORMAT: 'yyyy年MM月dd日 HH:mm',
                DEFAULT_CHINA_DAY_FORMAT: 'M月d日',
                DEFAULT_DATE_FORMAT: 'yyyy-MM-dd',
                DEFAULT_DAY_CN_FORMAT: 'MM月dd日',
