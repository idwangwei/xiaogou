/**
 * Created by WangLu on 2016/12/8.
 */
import {Inject, View, Directive, select} from '../../module';

@View('weixin_pay_protocol', {
    url: '/weixin_pay_protocol/:urlFrom/:backUrl/:backWorkReportUrl/:xlyType',
    styles: require('./style.less'),
    template: require('./weixin_pay_protocol.html'),
    inject:['$scope'
        , '$state'
        , '$rootScope'
        , '$stateParams'
...
class WeixinPayProtocol{
    ...
    initData() {
        ...
        this.urlBack = this.getStateService().params.backUrl || "weixin_pay_select";//this.$stateParams.urlFrom;
        this.xlyType = this.getStateService().params.xlyType;
        this.backWorkReportUrl = this.getStateService().params.backWorkReportUrl;
        this.protocolText =
            this.urlBack === 'year_card_pay' ?
                [{
                    clauseTitle: "1.服务条款的接受与修改",
                    clauses: ['1)本协议由您和四川爱里尔科技有限公司（以下简称“爱里尔科技”）共同签署，' +
                    '在您使用“智算365”软件服务平台并开通VIP优惠功能“学霸培养计划”之前，请仔细阅读本协议(无民事行为能力人、限制民事行为能力人' +
                    '应在法定监护人陪同下阅读)。'
                ...
                clauseTitle: "1.服务条款的接受与修改",
                clauses: ['1)本协议由您和四川爱里尔科技有限公司（以下简称“爱里尔科技”）共同签署，' +
                '在您使用“智算365”软件服务平台并开通付费功能“学霸驯宠记”之前，请仔细阅读本协议(无民事行为能力人、限制民事行为能力人' +
                '应在法定监护人陪同下阅读)。'
                    , '2)一旦您使用智算365软件服务平台且在支付页面点击支付按钮，即表示您已仔细阅读并同意完全接受本协议所有条款和所有条件的' +
                    '约束，并自动成为智算365的充值用户。'
                    , '3）注意：您正在购买付费内容，无民事行为能力、限制民事行为能力人应在法定监护人陪同下完成购买。' +
