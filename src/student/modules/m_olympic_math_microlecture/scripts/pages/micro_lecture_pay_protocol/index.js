...
@View('micro_lecture_pay_protocol', {
    url: '/micro_lecture_pay_protocol',
...
class microLecturePayProtocol {
    ...
    protocolText = [{
        ...
        '在您使用“智算365”软件服务平台并开通付费功能“思维训练”之前，请仔细阅读本协议(无民事行为能力人、限制民事行为能力人' +
        '应在法定监护人陪同下阅读)。'
...
export default microLecturePayProtocol;