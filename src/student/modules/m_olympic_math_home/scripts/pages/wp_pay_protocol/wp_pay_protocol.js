...
@View('wp_pay_protocol', {
    url: '/wp_pay_protocol/:urlFrom',
    template: require('./wp_pay_protocol.html'),
    styles: require('./wp_pay_protocol.less'),
    inject: [
        '$scope'
        , '$state'
        , '$rootScope'
...
class wpPayProtocol{
    ...
    initData() {
        ...
        this.protocolText = [{
            ...
            '在您使用“智算365”软件服务平台并开通付费功能“奥数魔法城”之前，请仔细阅读本协议(无民事行为能力人、限制民事行为能力人' +
            '应在法定监护人陪同下阅读)。'
