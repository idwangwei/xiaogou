...
@View('live_do_question', {
    url: '/live_do_question/:paperId/:paperInstanceId/:redoFlag/:questionIndex/:urlFrom/:urlFromMark/:isFirst',
...
class DoQuestionCtrl {
    ...
    onAfterEnterView() {
        ...
        debugger
        if(this.selectWork.liveToPay==1){
            this.timer=""
            this.thisTimer=""
    ...
    back(flag) {
        ...
        if(this.getStateService().params.urlFrom=="live"){
            param.urlFrom="live";
        }
        if(this.getStateService().params.urlFrom=="detail"&&this.getStateService().params.urlFromMark=="live"){
            param.urlFrom="detail";
            param.urlFromMark="live";
        }
        this.getRootScope().selectQuestionUrlFrom = 'doQuestion';
        // this.go("live_select_question",'back', param);
