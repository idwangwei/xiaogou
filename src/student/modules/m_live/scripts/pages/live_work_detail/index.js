...
@View('live_work_detail', {
    url: '/live_work_detail/:paperId/:paperInstanceId/:urlFrom',
...
class WorkDetailCtrl {
    ...
    redoWork() {
        ...
        if (this.getStateService().params.urlFrom == "live") {
            selectQuestionParam.urlFromMark = 'live';
        }
        this.getRootScope().selectQuestionUrlFrom = 'detail';
        this.go("live_select_question", selectQuestionParam); //返回做题
    }
    ...
    back() {
        if(this.selectWork.liveToPay==2){
