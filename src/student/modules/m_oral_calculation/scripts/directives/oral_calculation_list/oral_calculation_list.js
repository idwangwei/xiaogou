            ...
            this.getTemplate = function () {
                ...
                this.questionList.forEach((quesInfo, index) => {
                    ...
                    if (this.correctStatus !== CORRECT_STATUS.DO_QUESTION) {
                        tempClass = 'oral-question-correct';
                    } else {
                        tempClass = '';
                        style = this.hasFrac ? 'padding:50px 0 50px 0' : '';
                    }
                    oralCalculationListTemplate += `
                            <div class="oral-question ${tempClass}" style="${style}">
                                 ${equationTemplate}
                            </div>
                            <div class="oral_calc_line ${tempClass}"></div>
                            `
                });
