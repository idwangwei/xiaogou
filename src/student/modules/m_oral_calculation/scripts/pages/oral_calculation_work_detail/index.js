...
@View('oral_calculation_work_detail', {
    url: '/oral_calculation_work_detail/:paperId/:paperInstanceId',
...
class oralCalculationWorkDetail {
    ...
    redoWork() {
        ...
        this.go("oral_calculation_select_question", selectQuestionParam); //返回做题
    }
