...
class oralCalculationDoQuestion {
    ...
    back(noPopups) {
        ...
        if (noPopups || !this.startTimeFlag) {
            ...
            this.go('home.oral_calculation_work_list', {fromUrl: "oral_work"});
            return;
        }
    ...
    complete(results,timeOver) {
        ...
        this.go("oral_calculation_do_question_check_answer", {spentTime:timeOver?this.limitTime*60:this.spentTime})
    }
