...
@View('final_sprint_diagnose_do_question', {
    url: '/final_sprint_diagnose_do_question/:urlFrom/:pointName/:pointIndex/:backWorkReportUrl',
...
class DiagnoseDoQuestion02Ctrl{
    ...
    showErrorRecords(){
        ...
        if(this.backWorkReportUrl){
            this.go('final_sprint_error_records','forward',{backWorkReportUrl:this.backWorkReportUrl});
        }else{
            this.go('final_sprint_error_records','forward');
        }
    }
    ...
    goToShowReport(){
        ...
        this.go('final_sprint_report', 'forward', {
