...
@View('final_sprint_select_question', {
    url: '/final_sprint_select_question/:paperId/:paperInstanceId/:redoFlag/:urlFrom/:questionIndex/:urlFromMark',
...
class SelectQuestionCtrl {
    ...
    goToCheck(bigQ, smallQ) {
        ...
        this.go("final_sprint_do_question", "forward", param);
    };
