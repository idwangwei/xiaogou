...
@View('final_sprint_work_detail', {
    url: '/final_sprint_work_detail/:paperId/:paperInstanceId/:urlFrom',
...
class WorkDetailCtrl {
    ...
    redoWork() {
        ...
        this.go("final_sprint_select_question", selectQuestionParam); //返回做题
    }
