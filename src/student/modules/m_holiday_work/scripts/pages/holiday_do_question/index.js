...
class HolidayDoQuestionCtrl extends BaseController {
    constructor() {
        super(arguments);
    ...
    back(flag) {
        ...
        this.go("holiday_select_question",'back', param);
    };
...
export default HolidayDoQuestionCtrl;
