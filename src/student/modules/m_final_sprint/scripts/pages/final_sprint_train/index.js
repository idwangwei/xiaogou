...
class finalSprintTrainCtrl {
    ...
    goToKnowledge(x){
        ...
        this.go('final_sprint_diagnose_do_question',{
    ...
    goToQuesRecord(item) {
        ...
        this.go('final_sprint_ques_record', {pointIndex: -1,urlFrom:"final_sprint_train",formText:"期末全真模拟密卷（"+this.selected_work.name+"）"});
    }
    mapActionToThis() {
