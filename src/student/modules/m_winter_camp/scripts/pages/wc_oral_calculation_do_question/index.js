...
import eraserActive from './../../../images/oral_calcu_imgs/eraserActive.png';
import eraser from './../../../images/oral_calcu_imgs/eraser.png';
import scrollUp from './../../../images/oral_calcu_imgs/scrollUp01.png';
import scrollDown from './../../../images/oral_calcu_imgs/scrollDown01.png';
import tipCards from './../../../images/oral_calcu_imgs/tip_cards.png';
import clock from './../../../images/oral_calcu_imgs/timeCountClock.png';

@View('wc_oral_calculation_do_question', {
    url: '/wc_oral_calculation_do_question/:paperId/:paperInstanceId/:redoFlag',
...
class oralCalculationDoQuestion {
    ...
    back(noPopups) {
        ...
        if (noPopups || !this.startTimeFlag) {
            ...
            this.go('home.winter_camp_home', {fromUrl: "oral_work"});
            return;
        }
        ...
        this.inputBoxList.forEach(inputBox => {
            if (inputBox.strokeList.length) {
                inputBoxListWithStrokes.push({
                    ...
                    hasDot: angular.element(`#${inputBox.id}`).parents('.content').text().indexOf(".") !== -1
                })
            } else {
                            ...
                            if (inputBoxListWithStrokes.length != 0) {
                                this.recognizeStrokesForInputBox(inputBoxListWithStrokes)
                                    .then(results => {
                                        //submit
                                        // this.saveAnsToLocalStore(results);
                                        this.complete(results,timeOver);
                                        // this.submitAnsAndPaper(() => {
                                        //     this.back(true);
                                        // }, false, null, this.spentTime * 1000);
                                        // this.addResultToInputBox(results);
    ...
    complete(results,timeOver) {
        ...
        this.go("wc_oral_calculation_do_question_check_answer", {spentTime:timeOver?this.limitTime*60:this.spentTime})
    }
