...
@View('wc_error_records', {
    url: '/wc_error_records/:pointName/:backWorkReportUrl',
...
class DiagnoseErrorQRecordsCtrl{
    ...
    back(){
        ...
        if(this.backWorkReportUrl){
            this.go('wc_diagnose_do_question','back',{'pointName':pointName,'backWorkReportUrl':this.backWorkReportUrl})
        }else{
            this.go('wc_diagnose_do_question','back',{'pointName':pointName})
        }
