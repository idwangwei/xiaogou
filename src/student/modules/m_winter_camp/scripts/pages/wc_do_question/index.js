...
@View('wc_do_question', {
    url: '/wc_do_question/:paperId/:paperInstanceId/:redoFlag/:questionIndex/:urlFrom/:urlFromMark/:isFirst',
...
class DoQuestionCtrl {
    ...
    back(flag) {
        ...
        if(this.getStateService().params.urlFrom=="winter_camp_home"){
            param.urlFrom="winter_camp_home";
        }
        if(this.getStateService().params.urlFrom=="detail"&&this.getStateService().params.urlFromMark=="winter_camp_home"){
            param.urlFrom="detail";
            param.urlFromMark="winter_camp_home";
        }
        this.getRootScope().selectQuestionUrlFrom = 'doQuestion';
        this.go("wc_select_question",'back', param);
    };
