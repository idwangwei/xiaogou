...
@Directive({
    selector: 'gameGoodsPayProtocol',
    template: require('./page.html'),
    styles: require('./style.less'),
    replace: true
})

@View('game_goods_pay_protocol', {
    url: '/game_goods_pay_protocol/',
    template: '<game_goods_pay_protocol></game_goods_pay_protocol>'
})

@Inject('$scope', '$state', '$rootScope', '$stateParams', '$ngRedux',  'gameGoodsPayServer','commonService')
class GameGoodsPayProtocol {
    $stateParams;
    gameGoodsPayServer;
    commonService;
    ...
    protocolText = [{
        ...
        '在您使用“智算365”软件服务平台并开通付费功能“魔力闯关”之前，请仔细阅读本协议(无民事行为能力人、限制民事行为能力人' +
        '应在法定监护人陪同下阅读)。'
    ...
    back(){
        this.go("game_goods_pay",'forward', {backUrl:'game_goods_pay_result'});
    }

}

export default GameGoodsPayProtocol;