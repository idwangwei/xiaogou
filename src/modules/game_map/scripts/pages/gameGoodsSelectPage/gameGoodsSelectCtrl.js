...
@View('game_goods_select', {
    ...
    template: '<game-goods-select></game-goods-select>'
})

@Inject('$scope', '$state', '$rootScope', '$stateParams', '$ngRedux', '$window', '$ionicHistory', '$ionicLoading', '$ionicSlideBoxDelegate', 'gameGoodsPayServer', '$timeout')
