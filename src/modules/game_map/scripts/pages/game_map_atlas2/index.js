...
@Directive({
    selector: 'gameMapAtlas2',
    template: require('./page.html'),
    styles: require('./style.less'),
    replace: true
})

@View('game_map_atlas2', {
    url: '/game_map_atlas2/:avatorId/:mapId/:theme',
    template: '<game-map-atlas2></game-map-atlas2>'
})
...
class GameMapAtlas2 {
    ...
    gameMapInfoServer;
    commonService;
    @select(state => state.game_map_atlas_info.atlas2) avatorList;

    isWin = this.commonService.judgeSYS() === 3;
    lightId = this.$stateParams.avatorId || [];
    atlasId ="atlas2";
    theme = this.$stateParams.theme || 'theme02';
    ...
    getAtlasImg(imgId) {
        let url = 'game_map_atlas2/'+imgId + '.png';
