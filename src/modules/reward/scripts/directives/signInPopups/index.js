...
export default function () {
    return {
        ...
        replace: false,
        template: template,
        controller: ['$scope', '$rootScope', 'commonService', 'rewardSystemService','$timeout',function($scope, $rootScope, commonService, rewardSystemService,$timeout){
            const me = this;
            this.getCapacity = 0;
            this.signItemArr = [
            ...
            this.checkSignInFlag = ()=>{
                rewardSystemService.getSignInInfo().then((data)=>{
                    if(data && data.sign){
            ...
            this.clickItem = (item)=>{
                ...
                if(item.canSignIn){
                    rewardSystemService.doneSignIn().then((data)=>{
