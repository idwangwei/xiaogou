...
@View('reward_level_name', {
    ...
    template: '<level-name></level-name>'
})

@Inject('$scope', '$state', '$rootScope', '$stateParams', '$ngRedux', '$ionicHistory', 'rewardSystemService', '$ionicPopup', 'profileService', '$ionicLoading')
class levelNameCtrl {
