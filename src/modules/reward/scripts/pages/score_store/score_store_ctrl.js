...
@View('reward_score_store', {
    ...
    template: '<score-store></score-store>'
})

@Inject('$scope', '$state', '$rootScope', '$stateParams', '$ngRedux', '$ionicHistory',
    '$ionicPopup', 'rewardSystemService', '$ionicLoading','increaseScoreService','commonService')
