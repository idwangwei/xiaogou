...
export default function () {
    return {
        ...
        controller: ['$scope', '$rootScope', '$timeout', '$state', 'commonService', '$ionicPopup', 'finalSprintService', '$ngRedux', '$ionicViewSwitcher', '$ionicScrollDelegate',
            function ($scope, $rootScope, $timeout, $state, commonService, $ionicPopup, finalSprintService, $ngRedux, $ionicViewSwitcher, $ionicScrollDelegate) {
                ...
                $scope.gotoFinalSprintPage = function () {
                    /*清空当前周到state*/
                    finalSprintService.selectPaper({});
                    $scope.hideFinalSprintAdDialog();
                    $state.go('final_sprint_home');
