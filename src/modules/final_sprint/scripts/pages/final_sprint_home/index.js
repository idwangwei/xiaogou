...
@View('final_sprint_home', {
    url: 'final_sprint_home',
    template: '<final_sprint_home></final_sprint_home>'
})

@Inject( '$scope', '$state','$ngRedux','$stateParams','$ionicHistory','$rootScope',"finalSprintService","$ionicPopup","$ionicLoading","paperService","$timeout")
class finalSprintHomeCtrl {
    ...
    setPaperInfo(){
        ...
        this.finalSprintService.setSharingInfo({
    ...
    goDoPaper(index){
        ...
        this.go("select_question", param); //返回做题
    }
    /*去查看页面*/
    goToCheck(){
