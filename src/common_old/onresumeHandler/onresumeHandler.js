...
onresumeHandler.run(['$window', '$log', '$http', '$rootScope', '$state', 'serverInterface', '$timeout', 'commonService','$ngRedux',
    function ($window, $log, $http, $rootScope, $state, serverInterface, $timeout, commonService,$ngRedux) {
        ...
        function onResume() {
            ...
            if ($ngRedux.getState().profile_user_auth.logoutByUser || !profileInfo ) return;
